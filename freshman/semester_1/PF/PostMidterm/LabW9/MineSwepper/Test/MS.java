...
public class MS {
    static final int n_col = 20;
    static final int n_row = 10;
    // static final int n_col = 30;
    // static final int n_row = 20;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int t = 0; t < 7; t++)
        {
            ...
            long sl = 1000 / 2;
            TimeUnit.MILLISECONDS.sleep(sl);
            // System.out.println("\007");
            java.awt.Toolkit.getDefaultToolkit().beep();
            System.out.println(" \033[H\033[2J"); // clean console terminal
        }
    }

    static  int[][] markMap(int[][] mineMap) throws InterruptedException
    {
        displayMap(mineMap, "Map before mark warning", isDisplayArrayForm);
        countMine(mineMap);
        return mineMap;
    }
    ...
    static void displayMap(int[][] map, String desc,
        boolean arrayForm) throws InterruptedException
    {
        if (arrayForm)
        {
    ...
    static class Colors {
        ...
        public static final String[] SORTED_COLORS = {
            ...
            , BLACK_BRIGHT, ANSI_RESET, ANSI_PURPLE
        };
